...
namespace DefaultApp
{
    public class Builder
    {
        public static void ConfigureContainer()
        {
            ...
            builder.RegisterType<DefaultService>().As<DefaultInterface>();
            ...
            DefaultInterface defaultInterface = container.Resolve<DefaultInterface>();
            //var x = musicStoreService.DisplayAllAvailableSongs(1);
        }
    }
}